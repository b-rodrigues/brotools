---
title: "A collection of useful functions: welcome to the `brunoUtils` package!"
...
`brunoUtils` is a package that includes some useful functions to make the life of the DMD at 
